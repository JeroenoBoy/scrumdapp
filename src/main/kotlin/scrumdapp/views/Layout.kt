...
fun HTML.mainLayout(pageData: PageData, builder: BODY.() -> Unit = {}) {
    head {
        ...
        styleLink("https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@24,400,0,0&icon_names=add,arrow_back,cancel,check,delete_forever,edit,logout,settings,undo")
    }
    body {
        builder()
    }
